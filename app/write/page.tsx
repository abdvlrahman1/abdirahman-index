...
import { supabase } from "../lib/supabase"; // ✅ Connects to your database
...
export default function Write() {
  ...
  // Handle Image Upload (Converts image to code so it can be saved)
  ...
  const handlePublish = async () => {
    ...
    // ✅ Sends data to Supabase instead of Local Storage
    const { error } = await supabase
      ...
      .insert([
        { 
          ...
          category: category,
          content: content,
          image: image, // Saves the uploaded image
          date: date 
        }
      ]);
      ...
      <div className="w-full max-w-3xl animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="w-full relative group cursor-pointer">
                {/* This input captures the file from your computer */}
            ...
            <button 
                ...
                disabled={loading}
                className="mt-4 w-full py-4 bg-white text-black font-sans text-[10px] uppercase tracking-[0.3em] hover:bg-[#D4AF37] hover:text-white transition-colors disabled:opacity-50"
            >
                {loading ? "SAVING..." : "PUBLISH TO ARCHIVE"}
            </button>
